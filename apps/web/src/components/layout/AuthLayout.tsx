...
export const AuthLayout = ({ children }: PropsWithChildren) => {
  ...
  return (
    <main className="relative isolate flex min-h-screen items-center justify-center overflow-hidden bg-[#07071b] px-4 py-10 sm:px-6">
      ...
      <section className="relative w-full max-w-[462px] rounded-[36px] border border-violet-200/35 bg-[linear-gradient(145deg,rgba(52,45,112,0.9),rgba(13,14,47,0.96)_52%,rgba(34,23,80,0.91))] px-5 py-6 shadow-[0_30px_100px_rgba(0,0,0,0.52),inset_0_1px_0_rgba(255,255,255,0.3)] backdrop-blur-2xl transition-transform duration-500 lg:rotate-[-4deg] lg:scale-[0.78]">
