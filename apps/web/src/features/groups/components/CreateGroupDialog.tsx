...
export const CreateGroupDialog = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-950/45 p-4 backdrop-blur-sm">
      <div className="w-full max-w-xl rounded-3xl border border-line bg-card p-5 shadow-float dark:bg-slate-950">
        <div className="flex items-start justify-between gap-4">
          <div>
            <p className="text-xs font-semibold text-accent">NEW GROUP</p>
            <h2 className="mt-1 text-2xl font-semibold text-ink">Start a group</h2>
            <p className="mt-1 text-sm text-muted">Name your group and choose the people to add.</p>
          </div>
          <button
            type="button"
            onClick={onClose}
        ...
        <div className="mt-5 space-y-4">
          ...
          <div className="flex items-center justify-between gap-3">
            <p className="text-xs text-muted">
              Add at least two people to create a group.
            </p>
